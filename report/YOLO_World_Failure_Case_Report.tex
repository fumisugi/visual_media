...
研究テーマ & \multicolumn{3}{l}{映像からの競技用義足ブレードの3次元形状・姿勢推定} \\
\end{tabularx}
\vspace{0.5em}
\hrule
\vspace{0.7em}
...
次は実写defocus・motion blurで復元効果と前処理時間を測る。

\section{生成AI利用内容}

OpenAI Codexを要件整理、実験設計、コード、集計、図表、LaTeX草稿に使用した。
生成内容は実行結果および参照文献と照合し、実験条件、数値、考察は著者が確認した。
